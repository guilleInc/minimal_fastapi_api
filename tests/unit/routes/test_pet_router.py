...
class TestCreatePet:
    ...
    def test_create_pet_service_error(
        self, client: TestClient, mock_pet_service: AsyncMock
    ) -> None:
...
class TestListPets:
    ...
    def test_list_pets_empty(self, client: TestClient, mock_pet_service: AsyncMock) -> None:
    ...
    def test_list_pets_service_error(self, client: TestClient, mock_pet_service: AsyncMock) -> None:
...
class TestGetPet:
    ...
    def test_get_pet_service_error(self, client: TestClient, mock_pet_service: AsyncMock) -> None:
...
class TestUpdatePet:
    ...
    def test_update_pet_not_found(self, client: TestClient, mock_pet_service: AsyncMock) -> None:
    ...
    def test_update_pet_service_error(
        self, client: TestClient, mock_pet_service: AsyncMock
    ) -> None:
...
class TestDeletePet:
    ...
    def test_delete_pet_not_found(self, client: TestClient, mock_pet_service: AsyncMock) -> None:
    ...
    def test_delete_pet_service_error(
        self, client: TestClient, mock_pet_service: AsyncMock
    ) -> None:
